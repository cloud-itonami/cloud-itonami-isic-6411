# Operator Quickstart — Central banking

Shortest path from clone to a verified local dry-run for **ISIC 6411** (`cloud-itonami-isic-6411`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6411.git
cd cloud-itonami-isic-6411
```
...
- Blueprint governor key: `central-bank-reserve-governor`
- Likely source path: `reserve.governor.cljc`
